...
<!-- Two-column Section: Education and Interests -->
<div class="row">
  ...
  <div class="col-6">
    <h2>Education</h2>
    <ul>
      <li><strong>Carnegie Mellon University</strong>, PhD in Chemical Engineering </li>
      <li><strong>Indian Institute of Technology, Bombay</strong>, B.Tech in Chemical Engineering </li>
    </ul>
  </div>
